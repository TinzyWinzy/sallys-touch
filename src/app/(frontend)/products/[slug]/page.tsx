...
const fallbackData: Record<string, Product> = {
  'the-grace-tote': {
    title: 'The Grace Tote', price: 150,
  ...
  'the-noir-crossbody': {
    title: 'The Noir Crossbody', price: 120,
  ...
  'the-blossom-clutch': {
    title: 'The Blossom Clutch', price: 120,
  ...
  'the-dusk-satchel': {
    title: 'The Dusk Satchel', price: 150,
  ...
  'the-ember-shoulder': {
    title: 'The Ember Shoulder Bag', price: 150,
  ...
  'the-pearl-mini': {
    title: 'The Pearl Mini Bag', price: 120,
  ...
  'the-velvet-crescent': {
    title: 'The Velvet Crescent', price: 120,
  ...
  'the-gilded-bucket': {
    title: 'The Gilded Bucket', price: 150,
  ...
  'the-linen-market': {
    title: 'The Linen Market Bag', price: 150,
